...
class NormalLossDecayLandscape:
    ...
    def __init__(
        ...
        self.starting_mu_list = self._assign_normal_values(
            starting_mu_args,
            samples,
            starting_mu_dist,
            absolute=absolute
        ...
        self.ending_mu_list = self._assign_normal_values(
            ending_mu_args,
            samples,
            ending_mu_dist,
            absolute=absolute
        ...
        self.loss_slopes = self._gen_loss_slope(
    ...
    def generate_landscape(self):
        ...
        for time_step in range(self.max_time_steps):
            ...
            simulated_loss.append(
                np.absolute(self.noise_dist(cur_loss_mu_values, cur_std_values))
            )
